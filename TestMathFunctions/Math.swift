...
///Здесь мы создаем наши бесконечности с помощью Юникода. На данный момент, полученные символы нельзя конвертировать в числа. Я пробовал. Хотя, может, если использовать созданные свойства, в дальнейшем у Apple разработчиков получится сделать их полноценными числовыми множествами. Не будем загадывать
extension Double {
